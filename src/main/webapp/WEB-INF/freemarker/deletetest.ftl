<HTML>
	...
	<BODY>
		...
		<div class="bodyContainer">
			...
			<p>Are you sure you want to delete ${testName}?</p>
		...
		<script>
			$("#yes").on("click", function() {
				$.ajax({
	                ...
	                success: function( data, textStatus, jQxhr ){
	                	window.location.replace("${urlMappings.courseAdminViewUrl}/${courseId}#testsTab");
	                },
			...
			$("#no").on("click", function() { window.location.replace("${urlMappings.courseAdminViewUrl}/${courseId}#testsTab"); });
		</script>
